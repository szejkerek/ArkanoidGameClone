...
public:
	...
	virtual inline void PlaceOnScene(const sf::Vector2f& position, const ButtonType& buttonType, std::string displayText, const Scenes& sceneToLoad);
	virtual inline void PlaceOnScene(const sf::Vector2f& position, const ButtonType& buttonType, std::string displayText);
